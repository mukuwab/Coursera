## Key Concepts
<header>: Defines the header of a content section or the web page, often containing branding or navigation.
<article>: An independent, self-contained block of content such as a blog post or product.
<nav>: Specifies the navigation links of a section or the web page.
<main>: Indicates the main content of a section or the web page.
<video>: Embeds a video on a web page, allowing for multimedia content integration.
<footer>: Represents the footer of a content section or the web page, typically containing secondary links.
<table>: Defines a table element to display tabular data within a web page.
