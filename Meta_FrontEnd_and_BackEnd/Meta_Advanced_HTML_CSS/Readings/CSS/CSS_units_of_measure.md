...
Relative Units: Relative units are defined in relation to other elements or the viewport size, making them essential for responsive design across various devices.

Units of Measurement: Common units include pixels (px), em, rem, vw, vh, and percentages, each serving specific purposes in web design.

Absolute Units: Absolute units have a fixed size and are constant across different devices, making them suitable for known and unchanging dimensions.

Viewport: The viewport refers to the visible area of a web page, which can vary in size across different devices, influencing the choice of measurement units.
...
cm                 Centimeters           1cm = 37.8px = 25.264in                   
